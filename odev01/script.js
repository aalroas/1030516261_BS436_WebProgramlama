...
const newGame = () => {
    if(guess!==0){
        ...
        if(secondImages[0] === image){
            document.getElementById("messageId").innerHTML="You won !!! Congratulations :) If you want to play a new game, you can click <span class ='link' onclick='document.location.reload(true);'> here </span>.";
        }
        guess-=1;
    }else{
        document.getElementById("messageId").innerHTML="You lost :( If you want to play a new game, you can click <span class = 'link' onclick = 'document.location.reload (true);'> here </span>.";
    }
}
